...
{
	strcpy(txl[0].name, "a");
	strcpy(txl[0].addr, "HLJ");
	strcpy(txl[0].phone, "0452-12345678");
	strcpy(txl[0].workfor, "software engineering");

	strcpy(txl[1].name, "b");
	strcpy(txl[1].addr, "SH");
	strcpy(txl[1].phone, "0452-24244355");
	strcpy(txl[1].workfor, "computer");
